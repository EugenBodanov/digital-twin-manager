...
from src.dependency_graph.graph_ids import runtime_graph_id


class GraphIdTests(unittest.TestCase):
  def test_runtime_graph_id_uses_template_id_and_logical_name(self) -> None:
    self.assertEqual(
      "core:l1:dispatcher_iam:iam:dispatcher",
      runtime_graph_id("core:l1:dispatcher_iam:iam", "dispatcher"),
    )
